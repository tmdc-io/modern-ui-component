      ...
      variants: [
        {
          ...
          body: "Click a bar to select a run. Duration labels appear above each bar in the status color. status \"anomaly\" uses warn coloring; baseline draws the dashed reference line. See the drawer for the full runs array and selection callback.",
      ...
      variants: [
        {
          ...
          body: "Own selectedId in the parent to pair with RunCard, RunMetrics, or a detail drawer. Anomaly bars stay warn-colored; the selected column gets the elevated highlight.",
  ...
  variants: [
    {
      ...
      body: "Uncontrolled selection with anomaly and selected statuses.",
      Preview: RunDurationDefaultPreview,
      code: runDurationCodes.default,
    },
    {
      ...
      body: "selectedId + onSelectedChange for shell-driven selection.",
      Preview: RunDurationInteractivePreview,
      code: runDurationCodes.controlled,
    },
  ],
