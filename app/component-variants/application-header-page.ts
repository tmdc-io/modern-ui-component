      ...
      variants: [
        {
          ...
          body: "Use variant=\"l1\" on home or top-level routes. The tenant trigger shows the colored badge, tenant name, and chevron. Click to open the tenant list with a checkmark on the active item. Drawer includes the full tenants palette sample.",
      ...
      variants: [
        {
          ...
          body: "Final crumb has no href (current page). See drawer for the breadcrumbs array.",
      ...
      variants: [
        {
          ...
          body: "Pass className per tenant for pink/green/sky/amber sandbox badges. Drawer shows a four-tenant palette.",
          Preview: ApplicationHeaderTenantStatesPreview,
          code: applicationHeaderCodes.tenantStates,
          docLink: { href: "#api-reference", label: "Props reference" },
        },
      ],
    },
      ...
      variants: [
        {
          ...
          body: "Keep activeId / collapsed in the shell so header and sidebar stay aligned. Requires @modernui/dataos-sidebar.",
      ...
      variants: [
        {
          ...
          body: "Own tenantId so route loaders and feature flags can react to sandbox switches.",
  ...
  variants: [
    {
      ...
      body: "L1 tenant switch + user avatar.",
      Preview: ApplicationHeaderL1Preview,
      code: applicationHeaderCodes.l1,
    },
    {
      ...
      body: "L2 breadcrumbs for nested routes.",
      Preview: ApplicationHeaderL2Preview,
      code: applicationHeaderCodes.l2,
    },
    {
      ...
      body: "Pastel badge className per environment.",
      Preview: ApplicationHeaderTenantStatesPreview,
      code: applicationHeaderCodes.tenantStates,
    },
    {
